...
**Codes for importing data.**^[See [`childRmd/_importData.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_importData.Rmd) file for other codes]
