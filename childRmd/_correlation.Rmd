...
**Codes for generating correlation analysis**.^[See [`childRmd/_correlation.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_correlation.Rmd) file for other codes]
