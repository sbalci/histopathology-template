**Codes for generating fake data**.^[See [`childRmd/_generateFakeData.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_generateFakeData.Rmd) file for other codes]
