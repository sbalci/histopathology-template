...
```
Sadece "katılmış ve tamamlamış" olanları aldım. Toplam skorda tamamlanmamış olanlar düşük çıkıyor. Alternatif olarak "impute" deneyebiliriz.
```



```{r sadece katılmış ve tamamlamış olanları seç}
mydata <- mydata %>% 
