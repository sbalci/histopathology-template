**Codes for clean and recode data**.^[See [`childRmd/_cleanRecode.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_cleanRecode.Rmd) file for other codes]
