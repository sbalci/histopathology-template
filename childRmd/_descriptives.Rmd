**Codes for overviewing the data.**^[See `childRmd/_overView.Rmd` file for other codes]
...
# data(pbc)
library(tableone)
tableone::CreateTableOne(data = mydata)
```
...
```{r summarytools descriptives 1, eval=FALSE, include=FALSE}
...
```{r define continious variables 1, eval=FALSE, include=FALSE}
