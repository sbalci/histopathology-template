...
**Codes for general settings.**^[See [`childRmd/_header.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_header.Rmd) file for other general settings]
