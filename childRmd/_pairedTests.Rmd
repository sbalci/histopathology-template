**Codes for generating paired tests**.^[See [`childRmd/_pairedTests.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_pairedTests.Rmd) file for other codes]
