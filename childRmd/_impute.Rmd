...
```{r dlookr impute continious value knn}
carseats %>%
...
```{r dlookr impute categorical value mice}
library(mice)
...
```{r dlookr transform optimal binning}
...
```{r dlookr data transformation method}
carseats %>%
