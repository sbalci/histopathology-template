**Codes for defining variable types**.^[See [`childRmd/_variableTypes.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_variableTypes.Rmd) file for other codes]
