...
```{r describer 1, echo=TRUE, eval=FALSE}
mydata %>% 
    select(-keycolumns) %>% 
  describer::describe() %>% 
...
```{r find continious variables describer, echo=TRUE, eval=FALSE}
mydata %>%
...
```{r dataMaid, echo=TRUE, eval=FALSE}
...
visdat::vis_expect(data = airquality,
                   expectation = ~.x == -1,
                   show_perc = TRUE)
...
```{r DataExplorer 1, eval=FALSE, include=FALSE}
...
```{r DataExplorer 2, eval=FALSE, include=FALSE}
DataExplorer::plot_str(mydata, type = "r")
```


```{r DataExplorer 3, eval=FALSE, include=FALSE}
...
```{r DataExplorer 4, eval=FALSE, include=FALSE}
DataExplorer::plot_intro(mydata)
```


```{r DataExplorer 5, eval=FALSE, include=FALSE}
DataExplorer::plot_missing(mydata)
```


```{r DataExplorer 6, eval=FALSE, include=FALSE}
mydata2 <- DataExplorer::drop_columns(mydata, "TStage")
```


```{r DataExplorer 7, eval=FALSE, include=FALSE}
DataExplorer::plot_bar(mydata)
```


```{r DataExplorer 8, eval=FALSE, include=FALSE}
DataExplorer::plot_bar(mydata, with = "Death")
```


```{r DataExplorer 9, eval=FALSE, include=FALSE}
...
```{r xray 2, eval=FALSE, include=FALSE}
