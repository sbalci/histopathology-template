**Codes for overviewing the data.**^[See [`childRmd/_overView.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_overView.Rmd) file for other codes]
