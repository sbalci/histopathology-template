...
```{r load library shiny, eval=FALSE, cache=FALSE, include=FALSE}
library("shiny")
library("dplyr")
library("magrittr")
library("viridis")
...
```{r rad and recode data, eval=FALSE, cache=FALSE, include=FALSE}
...
```{r shiny output, eval=FALSE, cache=FALSE, include=FALSE}
selectInput(
  inputId = "Factor",
