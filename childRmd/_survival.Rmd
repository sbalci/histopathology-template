**Codes for Survival Analysis**^[See [`childRmd/_survival.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_survival.Rmd) file for other codes, and [`childRmd/_shinySurvival.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_shinySurvival.Rmd) for `shiny` application]
