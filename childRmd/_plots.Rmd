...
**Codes for generating Plots**.^[See [`childRmd/_plots.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_plots.Rmd) file for other codes]
