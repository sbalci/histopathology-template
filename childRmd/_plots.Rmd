...
```{r SmartEDA Boxplot by category}
...
```{r SmartEDA density plot by category}
...
```{r SmartEDA scatterplot by category}
...
```{r SmartEDA scatterplots by category 2}
