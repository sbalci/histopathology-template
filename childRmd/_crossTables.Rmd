**Codes for cross tables**.^[See [`childRmd/_crossTables.Rmd`](https://github.com/sbalci/histopathology-template/blob/master/childRmd/_crossTables.Rmd) file for other codes]
