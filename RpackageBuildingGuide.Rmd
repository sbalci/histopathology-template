...
write_compendium_description(package = "Histopathology Template", 
                             description = "Codes For Histopathology Research")

<!-- # to write a description, with dependencies. Be sure to fill in placeholder text -->

write_dockerfile(maintainer = "Serdar Balci") 
...
https://www.coursera.org/learn/reproducible-templates-analysis/lecture/kMdRj/create-an-r-package-with-an-r-markdown-template
...
# xfun::gsub_files(
#   files = files_replace,
#   pattern = ", eval=FALSE, include=FALSE",
#   replacement = "",
#   fixed = TRUE
# )
# xfun::gsub_files(
